...
const AddStudentComponent = () => {
    ...
    const saveOrUpdateStudent = (e) => {
        ...
        const students = {firstName, lastName, emailId}

        if(id){
            StudentService.saveOrUpdateStudent(id, students).then((response) => {
                history('/students')
            }).catch(error => {
                console.log(error)
            })
            ...
            StudentService.createStudents(students).then((response) =>{
